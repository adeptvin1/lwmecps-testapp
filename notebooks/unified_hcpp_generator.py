...
class Config:
    ...
    OPENCELLID_REGIONS = {
        ...
        'spb': (59.8, 60.1, 30.0, 30.6),         # Санкт-Петербург (центр)
    ...
    FIGURE_SIZE_SPATIAL_ANALYSIS = (10, 8)  # размер графика для пространственного анализа
    FIGURE_SIZE_PARAMS = (8, 5)  # размер графика для сравнения параметров
